...
const errorTitle = computed(() => {
  ...
  if (errors.starlink) return "Error al cargar Starlink";
  if (errors.upcomingLaunches) return "Error al cargar próximos lanzamientos";
  return "Error del dashboard";
});
...
onMounted(async () => {
  ...
  await spacexStore.loadDashboardData();
});
