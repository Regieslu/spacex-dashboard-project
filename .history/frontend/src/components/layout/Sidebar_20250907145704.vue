<template>
  ...
  >
    <div class="brand">
      ...
      <span class="name" v-show="!isCollapsed">SpaceX</span>
    </div>
...
/* Desktop: sin botón mobile, mostrar botones collapse */
...
/* Mobile: ocultar botones collapse */
@media (max-width: 900px) {
  .collapse-btn,
  .expand-btn {
    display: none;
