  ...
  option.value = {
    ...
    globe: {
      ...
      viewControl:viewControl: {
        autoRotate: true,
        autoRotateSpeed: 3,
        distance: 200, // ← Ajusta la distancia (zoom out)
        minDistance: 100, // ← Distancia mínima
        maxDistance: 400, // ← Distancia máxima
        alpha: 20, // ← Ángulo de rotación vertical
        beta: 0, // ← Ángulo de rotación horizontal
        zoomSensitivity: 0.8, // ← Sensibilidad del zoom
        rotateSensitivity: 0.8 // ← Sensibilidad de rotación
      },
    },
    visualMap: {
      show: false,
