  ...
  option.value = {
    ...
    globe: {
      ...
      viewControl: {
        ...
        minDistance: 100, // zoom in
        maxDistance: 400, // zoom out
        alpha: 20, // vertical rotation
        beta: 0, // horizontal rotation
        zoomSensitivity: 0.8, // zoom sensitivity
        rotateSensitivity: 0.8, // rotation sensitivity
      },
    },
    visualMap: {
      show: false,
