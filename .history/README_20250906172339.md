...
¡Listo! He creado el archivo README.md en la raíz de tu proyecto con toda la información necesaria para el onboarding. El archivo incluye:
...
- Información sobre contribución

Ahora cualquier persona que clone tu proyecto podrá seguir estas instrucciones para configurar y ejecutar el dashboard de SpaceX correctamente.
